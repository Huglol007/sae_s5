...
final class RessourceControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'ressource[name]' => 'Testing',
            'ressource[type]' => 'Testing',
            'ressource[state]' => 'Testing',
            'ressource[referent]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'ressource[name]' => 'Something New',
            'ressource[type]' => 'Something New',
            'ressource[state]' => 'Something New',
            'ressource[referent]' => 'Something New',
        ]);
